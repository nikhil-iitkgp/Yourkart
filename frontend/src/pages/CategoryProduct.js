    ...
    <div className=' container mx-auto p-4'>
      ...
      <div className='hidden lg:grid grid-cols-[200px,1fr]'>
        ...
        <div className='bg-white p-2 min-h-[calc(100vh-120px)] max-h-[calc(100vh-120px)] overflow-y-scroll'> 
          {/**sort by */}
          <div className=''>
            <h3 className='text-base font-medium text-slate-500 border-b border-slate-300'>Sort By</h3>
          ...
          {/**filter by */}
          <div className=''>
            <h3 className='text-base font-medium text-slate-500 border-b border-slate-300'>Filter By</h3>
            <form className='text-sm flex flex-col py-2 gap-2'>
              {
                productCategory.map((categoryName,index)=>{
                  return(
                    <div>
                      <input type='checkbox' name='category' checked={selectCategory[categoryName?.value]} value={categoryName?.value} id={categoryName?.value} onChange={handleSelectedCategory}/>
