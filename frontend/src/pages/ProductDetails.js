      ...
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        {loading ? (
          <div className="flex flex-col gap-3 w-full mr-80">
            ...
            <p className="bg-slate-200 rounded-full w-full animate-pulse h-6 lg:h-8"></p>
            <p className="bg-slate-200 rounded-full w-full animate-pulse h-6 lg:h-8"></p>
            <div className="flex text-red-600 items-center gap-1"></div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3 my-2">
              <button
                className="border-2 border-red-600 px-3 py-1 min-w-[100px] rounded text-red-600 font-medium hover:bg-red-600 hover:text-white"
